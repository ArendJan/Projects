...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button volts = (Button) findViewById(R.id.voltsB);
        volts.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                new RequestTask().execute(ip + "VOLT", "2"); //Request the volts, put it in the other textview.
                //The "1" is for the correct textview, if you have more than 1,
                // you can set the correct destination of the output, or what has to be done with it.
            }
        });
        ...
        protected void onPostExecute(String result) {
            ...
            if(!error){
                ...
                if(MODE == 0){
                    ...
                    TextView textView = (TextView) findViewById(R.id.voltsTV);
                    textView.setText("Calculating....");
                    int value = Integer.parseInt(result);
                    double volts = value/1023.0*5.0;
                    textView.setText(volts+" Volts");
                }
